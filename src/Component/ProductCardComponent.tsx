...
interface ProductCardProps {
  ...
  onColorClick: (variant: ProductVariant, productIndex: number) => void;
...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div
            key={index}
            className="rounded-md border border-slate-500 overflow-hidden shadow-lg shadow-inner mt-5  m-4 bg-gray-700"
            style={{ maxWidth: "305px", marginTop: "50px" }}
          >
            <img
              className="w-full"
                  ...
                  <div className="mt-5 flex justify-between items-center">
                    ...
                    <span
                      className={`cursor-pointer p-2 text-3xl flex items-center justify-center border w-14 border-white rounded-lg ${
                        wishlist[index] ? "text-red-500" : "text-white"
                      }`}
